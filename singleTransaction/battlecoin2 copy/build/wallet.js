...
const createTxOuts = (receiverAddress, myAddress, amount, amountVictory, leftOverAmount) => {
    const txOut1 = new transaction_1.TxOut(receiverAddress, amount, amountVictory);
    if (leftOverAmount === 0) {
        return [txOut1];
    }
    else {
        const leftOverTx = new transaction_1.TxOut(myAddress, leftOverAmount, amountVictory); //SPREMENI V LEFTOVER VICTORY
...
const createTransaction = (receiverAddress, amount, amountVictory, privateKey, unspentTxOuts, txPool) => {
