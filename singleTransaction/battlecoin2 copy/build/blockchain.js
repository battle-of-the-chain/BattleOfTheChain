...
const generatenextBlockWithTransaction = (receiverAddress, amount, amountVictory) => {
    ...
    const coinbaseTx = transaction_1.getCoinbaseTransaction(wallet_1.getPublicFromWallet(), getLatestBlock().index + 1);
    const tx = wallet_1.createTransaction(receiverAddress, amount, amountVictory, wallet_1.getPrivateFromWallet(), getUnspentTxOuts(), transactionPool_1.getTransactionPool());
...
const sendTransaction = (address, amount, amountVictory) => {
    const tx = wallet_1.createTransaction(address, amount, amountVictory, wallet_1.getPrivateFromWallet(), getUnspentTxOuts(), transactionPool_1.getTransactionPool());
