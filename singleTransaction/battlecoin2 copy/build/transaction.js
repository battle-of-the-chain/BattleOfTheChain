...
*/
class UnspentTxOut {
    constructor(txOutId, txOutIndex, address, amount, amountVictory) {
...
*/
class TxOut {
    constructor(address, amount, amountVictory) {
        this.address = address;
        this.amount = amount;
        this.amountVictory = amountVictory;
    }
...
const getTransactionId = (transaction) => {
    ...
    const txOutContent = transaction.txOuts
        .map((txOut) => txOut.address + txOut.amount + txOut.amountVictory)
        .reduce((a, b, c) => a + b + c, '');
