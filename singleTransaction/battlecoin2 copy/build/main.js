...
const initHttpServer = (myHttpPort) => {
    ...
    app.post('/mineTransaction', (req, res) => {
        ...
        try {
            const resp = blockchain_1.generatenextBlockWithTransaction(address, amount, 0); //0 je amount victory
            res.send(resp);
        }
        catch (e) {
    ...
    app.post('/sendTransaction', (req, res) => {
        try {
            ...
            const resp = blockchain_1.sendTransaction(address, amount, 0); //0 je amount victory
            res.send(resp);
        }
        catch (e) {
            console.log(e.message);
